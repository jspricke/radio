...
class Stations(dict):
  def __init__(self):
    ...
    self['n'] = Station('Nordwestradio', 'http://httpmedia.radiobremen.de/nordwestradio.m3u', nordwestradio)
    ...
    self['q'] = Station('Nordwestradio Sounds', 'http://webchannel.radiobremen.de:8000/nordwestradio-sounds.m3u')
